...
//	public ActionsUtil actions;
	...
	public void openApplication(@Optional("chrome")String browserName) throws Exception {
		...
		String url =data.readDataFromPropertyFile(PROPERTIES_PATH,"url");
		driver.get(url);
	...
	public void loginToApplication() throws Exception {
		String username=data.readDataFromPropertyFile(PROPERTIES_PATH,"username");
		String password=data.readDataFromPropertyFile(PROPERTIES_PATH,"password");
